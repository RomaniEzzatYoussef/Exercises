...
public class Exercise_03 {
	...
	public static void main(String[] args) 
	{
		...
		t1s1 = AVERAGE_EARTH_RADIUS * 
				Math.acos(Math.sin(Math.toRadians(xAtlantaGeorgia)) * Math.sin(Math.toRadians(xOrlandoFlorida)) * 
						Math.cos(Math.toRadians(xAtlantaGeorgia)) * Math.cos(Math.toRadians(xOrlandoFlorida)) * 
						Math.cos(Math.toRadians(yAtlantaGeorgia - yOrlandoFlorida))
						);
		t1s2 = AVERAGE_EARTH_RADIUS * 
				Math.acos(Math.sin(Math.toRadians(xOrlandoFlorida)) * Math.sin(Math.toRadians(xSavannahGeorgia)) * 
						Math.cos(Math.toRadians(xOrlandoFlorida)) * Math.cos(Math.toRadians(xSavannahGeorgia)) * 
