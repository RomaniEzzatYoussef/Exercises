 ...
 * Revise the program so that it finds two points in a three-dimensional space nearest to each other. 
...
public class Exercise_07 
{
	...
	public static void main(String[] args) 
	{
		...
		int p1 = 0, p2 = 1;
		double shortestDistance = distance(points[0][0], points[p1][1], points[p1][2], points[p2][0], points[p2][1], points[p2][2]);
