...
public class Exercise_09 
{
	public static void main(String[] args)
	{
		...
		System.out.println("Regular Polygon 1:: Perimeter: " + rp1.getPerimeter() + " Area: " + rp1.getArea());
		
		RegularPolygon rp2 = new RegularPolygon(6 , 4);
		System.out.println("Regular Polygon 2:: Perimeter: " + rp2.getPerimeter() + " Area: " + rp2.getArea());
		
		RegularPolygon rp3 = new RegularPolygon(10 , 4 , 5.6 , 7.8);
		System.out.println("Regular Polygon 3:: Perimeter: " + rp3.getPerimeter() + " Area: " + rp3.getArea());
