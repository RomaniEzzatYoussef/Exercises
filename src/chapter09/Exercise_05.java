...
public class Exercise_05 {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Today is " + gc.get(GregorianCalendar.DAY_OF_MONTH) + "\\" + gc.get(GregorianCalendar.MONTH + 1) + "\\"
		+ gc.get(GregorianCalendar.YEAR));
		
		gc.setTimeInMillis(1234567898765L);
		
		//Displays the time after the class has been modified with a set milliseconds of time 
		System.out.println("Today is " + gc.get(GregorianCalendar.MONTH) + "\\" + gc.get(GregorianCalendar.DAY_OF_MONTH) + "\\" + gc.get(GregorianCalendar.YEAR));
		
		System.out.println("Hour is " + gc.get(GregorianCalendar.HOUR) + " Minute is " + gc.get(GregorianCalendar.MINUTE));
	}
