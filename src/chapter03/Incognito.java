...
public class Incognito extends javax.swing.JFrame { 	
   ...
   // @SuppressWarnings("unchecked")  
    ...
    { 
    	try{
	            	File file = new File("ExportedHistory/history.txt");
					if(file.createNewFile())
					{
						JOptionPane.showMessageDialog(null,"History successfully exported,\nPlease check HistoryExported folder");
							mes = txt_chatarea.getText();
						
							BufferedWriter writer = null;
							try
							{ 
							    writer = new BufferedWriter( new FileWriter("ExportedHistory/history.txt"));
							    writer.write(mes +"");
							    writer.newLine();
